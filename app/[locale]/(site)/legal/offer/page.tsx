  ...
  return (
    <LegalPageLayout title="Договір публічної оферти">
      ...
      <LegalSection title="4. ЦІНА ТОВАРУ ТА ПОРЯДОК ОПЛАТИ">
        ...
        <p>
          <strong>4.2.</strong> Оплата здійснюється одним із способів:
        </p>
        <ul className="ml-4 mt-2 list-disc space-y-2">
          <li>
            <strong>Онлайн-оплата (інтернет-еквайринг):</strong> безготівковий розрахунок
            банківською карткою безпосередньо на сайті при оформленні Замовлення (платіжний сервіс
            ПУМБ / Hutko).
          </li>
          <li>
            <strong>Післяплата (накладений платіж):</strong> оплата готівкою або банківською карткою
            при отриманні Товару у відділенні «Нової Пошти».
          </li>
        </ul>
        <p>
          <strong>4.3.</strong> При виборі післяплати Покупець додатково сплачує комісію
          транспортної компанії за переказ коштів згідно з її тарифами.
        </p>
      </LegalSection>
      ...
      <LegalSection title="6. ПОВЕРНЕННЯ ТА ОБМІН ТОВАРУ">
        <p>
          <strong>6.1.</strong> Відповідно до Закону України «Про захист прав споживачів», Покупець
          має право на обмін або повернення Товару належної якості протягом 14 (чотирнадцяти) днів,
          не рахуючи дня купівлі.
        </p>
        <p>
          <strong>6.2.</strong> Обмін або повернення Товару здійснюється за умови, якщо:
        </p>
        <ul className="ml-4 mt-2 list-disc space-y-2">
          <li>Товар не використовувався, не має слідів носіння, прання чи забруднень;</li>
          <li>збережено його товарний вигляд, споживчі властивості, фабричні ярлики та бірки;</li>
          <li>
            збережено розрахунковий документ (електронна квитанція або товарний чек), виданий
            Покупцеві разом із проданим Товаром.
          </li>
        </ul>
        <p>
          <strong>6.3.</strong> Витрати на доставку Товару при поверненні або обміні несе Покупець.
          У разі повернення товару неналежної якості (браку), витрати на доставку бере на себе
          Продавець.
        </p>
        <p>
          <strong>6.4.</strong> Для оформлення повернення Покупець повинен зв&apos;язатися з
          Продавцем за контактами, вказаними в розділі 9. Повернення коштів здійснюється на
          банківську картку Покупця протягом 7 робочих днів після отримання та огляду повернутого
          Товару Продавцем.
        </p>
      </LegalSection>

      <LegalSection title="7. ВІДПОВІДАЛЬНІСТЬ СТОРІН ТА ВИРІШЕННЯ СПОРІВ">
        <p>
          <strong>7.1.</strong> Продавець не несе відповідальності за шкоду, заподіяну Покупцеві
          внаслідок неналежного використання Товарів.
        </p>
        <p>
          <strong>7.2.</strong> Усі суперечки вирішуються шляхом переговорів. У разі недосягнення
          згоди — у судовому порядку згідно з чинним законодавством України.
        </p>
      </LegalSection>

      <LegalSection title="8. КОНФІДЕНЦІЙНІСТЬ ТА ЗАХИСТ ПЕРСОНАЛЬНИХ ДАНИХ">
        <p>
          <strong>8.1.</strong> Оформлюючи Замовлення, Покупець надає свою згоду на збір та обробку
          своїх персональних даних відповідно до Закону України «Про захист персональних даних».
        </p>
        <p>
          <strong>8.2.</strong> Інформація, яку надає Покупець, використовується виключно для
          обробки Замовлення, доставки Товару та інформування Покупця.
        </p>
      </LegalSection>

      <LegalSection title="9. РЕКВІЗИТИ ПРОДАВЦЯ">
